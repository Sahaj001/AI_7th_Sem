...
if __name__ == "__main__":
    ...
    inputfile = "/Users/sahajsingh/Desktop/AI_7th_Sem/input.txt"
    x = []
    ...
    outputfile = "/Users/sahajsingh/Desktop/AI_7th_Sem/output.txt"
    y = []
    ...
    solve(x, empty_tile_pos, y)
    Game = game()
    Game.run(store,count)
